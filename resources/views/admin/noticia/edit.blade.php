<div class="modal fade" aria-hidden="true" aria-labelledby="mediumModalLabel" role="dialog" tabindex="-1" id="modal-update-{{$noticia->cod_noticias}}" style="margin-top: 50px;">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            {{Form::Open(array('action'=>array('\App\Http\Controllers\NoticiaController@update',$noticia->cod_noticias),'method'=>'GET'))}}
            {{Form::token()}}
                    ...
                    <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                        <div class="tab-content" id="nav-tabContent">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <textarea id="descripcion" rows="5" name="descripcion" placeholder="Descripción" class="form-control ckeditor" value="{!!$noticia->descripcion!!}" required></textarea>
                                </div>
                            </div>
                            <div class="row form-group">
                                <div class="col col-md-3">
