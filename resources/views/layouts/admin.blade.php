...
<head>
    ...
    <title>Efinergy - Consultora del Perú</title>
    ...
    <div data-ps-id="df6a5ce4-a175-9172-4402-dabd98fc9c0a" class="customizer-content p-3 ps-container ps-theme-dark">
        ...
        <div class="tl-bg-img d-none">
            ...
            <div class="cz-tl-bg-image row">
                <div class="col-sm-3"><img src="{{asset('img/gallery/bg-glass-1.jpg')}}" width="90" class="rounded bg-glass-1 selected"></div>
                <div class="col-sm-3"><img src="{{asset('img/gallery/bg-glass-2.jpg')}}" width="90" class="rounded bg-glass-2"></div>
                <div class="col-sm-3"><img src="{{asset('img/gallery/bg-glass-3.jpg')}}" width="90" class="rounded bg-glass-3"></div>
                <div class="col-sm-3"><img src="{{asset('img/gallery/bg-glass-4.jpg')}}" width="90" class="rounded bg-glass-4"></div>
            </div>
        </div>
        <!-- Transparent BG Image Ends    -->
        <hr>
